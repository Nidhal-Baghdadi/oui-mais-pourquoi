...
const RenderModelTree = ({ children, className }) => {
  return (
    <Canvas className={clsx("w-screen h-screen z-10 relative", className)}>
      <directionalLight position={[0, 3, 1]} intensity={7} />
      ...
      <Stars
        ...
        speed={0.3}
      />
      <Sparkles count={1000} size={3} speed={0.3} opacity={1} scale={56} />
...
export default RenderModelTree;
